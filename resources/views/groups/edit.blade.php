    ...
    <div class="container-fluid px-3 px-lg-4 py-4">
        <div class="row justify-content-center">
            <div class="col-12 col-md-8 col-lg-6">
                ...
                <!-- Heading -->
        <h2 class="mb-4 fw-bold text-primary">{{ __('messages.edit') }} {{ $group->name }}</h2>
                ...
                <form action="{{ route('groups.update', $group->id) }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="name" id="name"
                            ...
                            value="{{ old('name') ?: $group->name }}" placeholder="{{ __('messages.enter') }} {{ __('messages.name') }}"
                            required>
                        @error('name')
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="abbreviation" id="abbreviation"
                            ...
                            value="{{ old('abbreviation') ?: $group->abbreviation }}" placeholder="{{ __('messages.enter') }} {{ __('messages.abbreviation') }}"
                            required>
                        @error('abbreviation')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="d-flex gap-2">
                        <button type="submit" class="btn btn-success w-100 py-2 rounded-3">
                            <i class="fa fa-plus-circle me-1"></i> {{ __('messages.update') }}
                        </button>
