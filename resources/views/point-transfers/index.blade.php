...
@section('content')
    <div class="container-fluid px-3 px-lg-4 py-4">
        <x-page-header icon="fa-exchange-alt" :title="__('messages.point_transfers')">
            <x-slot:actions>
        ...
        <div class="card rounded-4 shadow-soft mb-4">
            <div class="card-body">
                <form method="GET" action="{{ route('point-transfers.index') }}" class="row g-3">
                    <div class="col-md-3">
                    ...
                    <div class="col-md-2">
                        <label for="family_code" class="form-label">{{ __('messages.family_code') }}</label>
                    ...
                    <tbody>
                        @forelse($transfers as $transfer)
                            <tr>
                                ...
                                <td>
                                    <span class="badge bg-success-subtle text-success">{{ $transfer->points }}</span>
                                </td>
                                <td><span class="badge bg-info-subtle text-info">{{ $transfer->family_code }}</span></td>
                ...
                <div class="card mb-3 rounded-4 shadow-soft">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-start mb-2">
                            ...
                            <span class="badge bg-success-subtle text-success">{{ $transfer->points }} pts</span>
                        </div>
                        <div class="mb-2">
                        ...
                        <div class="mb-2">
                            ...
                            <span class="badge bg-info-subtle text-info">{{ $transfer->family_code }}</span>
                        </div>
                        <div class="mb-2">
