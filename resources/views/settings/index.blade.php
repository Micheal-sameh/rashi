...
@section('content')
    <div class="container-fluid px-3 px-lg-4 py-4">
        ...
        <!-- Page Header -->
        <x-page-header icon="fa-cogs" :title="__('messages.Application Settings')" :subtitle="__('messages.settings')">
            <x-slot:actions>
                    ...
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="card border-0 shadow-soft rounded-4 h-100">
                            <div class="card-body p-4 d-flex flex-column justify-content-between">
                                ...
                                <!-- Setting Header -->
                                <div class="mb-3">
                                    <h6 class="rs-title-lg text-capitalize mb-1">
        ...
        <div class="mt-5">
            <div class="card border-danger shadow-soft rounded-4">
                <div class="card-body">
                    <h5 class="rs-title-lg text-danger mb-3">
                        <i class="fa fa-exclamation-triangle me-2"></i> {{ __('messages.danger_zone') }}
                    </h5>
                    <p class="rs-body-lg mb-4">
                        {{ __('messages.logout_all_mobiles') }}
                    </p>
                    <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#deleteTokensModal">
