            ...
            <div class="card shadow-sm mb-4">
                <div class="card-header bg-gradient" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);">
                    <div class="d-flex align-items-center text-white">
                        ...
                        <div>
                            <h4 class="mb-1">{{ $memberData['user']->name }}</h4>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            <div class="p-3 bg-light rounded">
                                ...
                                <p class="h5 mb-0">{{ $memberData['quizzes_solved'] }} / {{ $memberData['total_quizzes'] }}</p>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="p-3 bg-light rounded">
                                ...
                                @if($memberData['last_quiz'])
                                    ...
                                    <small class="text-muted">{{ $memberData['last_quiz']['date'] ? \Carbon\Carbon::parse($memberData['last_quiz']['date'])->format('Y-m-d H:i') : 'N/A' }}</small>
                                @else
                        ...
                        <div class="col-md-6">
                            <div class="p-3 bg-light rounded">
                                ...
                                @if($memberData['last_order'])
                                    ...
                                    <small class="text-muted">{{ $memberData['last_order']['date']->format('Y-m-d H:i') }}</small>
                                @else
                                    <p class="mb-0 text-muted">{{ __('messages.no_data') }}</p>
                                @endif
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="p-3 bg-light rounded">
                                ...
                                @if($memberData['last_bonus'])
                                    <p class="mb-1 text-success"><strong>+{{ $memberData['last_bonus']['value'] }} {{ __('messages.points') }}</strong></p>
                                    <small class="text-muted">{{ $memberData['last_bonus']['date']->format('Y-m-d H:i') }}</small>
                                @else
                                    <p class="mb-0 text-muted">{{ __('messages.no_data') }}</p>
                                @endif
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="p-3 bg-light rounded">
                                ...
                                @if($memberData['last_penalty'])
                                    <p class="mb-1 text-danger"><strong>-{{ $memberData['last_penalty']['value'] }} {{ __('messages.points') }}</strong></p>
                                    <small class="text-muted">{{ $memberData['last_penalty']['date']->format('Y-m-d H:i') }}</small>
                                @else
                                    <p class="mb-0 text-muted">{{ __('messages.no_data') }}</p>
                                @endif
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="p-3 bg-light rounded">
                                ...
                                @if($memberData['last_competition'])
                                    ...
                                    <small class="text-muted">{{ $memberData['last_competition']['date'] ? \Carbon\Carbon::parse($memberData['last_competition']['date'])->format('Y-m-d H:i') : 'N/A' }}</small>
                                @else
                                    <p class="mb-0 text-muted">{{ __('messages.no_data') }}</p>
                                @endif
                            </div>
